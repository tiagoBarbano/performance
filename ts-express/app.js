...
if (clusterWorkerSize > 1) {
    if (cluster_1.default.isMaster) {
        ...
        cluster_1.default.on("exit", function (worker) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, console.log("Worker", worker.id, " has exitted.")];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        app.listen(PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, console.log("Express server listening on port ".concat(PORT, " and worker ").concat(process.pid))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    app.listen(PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, console.log("Express server listening on port ".concat(PORT, " with the single worker ").concat(process.pid))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
